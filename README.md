...
1. 💪 Opened PR [#5](https://github.com/mattstruble/zero-router/pull/5) in [mattstruble/zero-router](https://github.com/mattstruble/zero-router)
2. 🎉 Merged PR [#4](https://github.com/mattstruble/zero-router/pull/4) in [mattstruble/zero-router](https://github.com/mattstruble/zero-router)
3. 💪 Opened PR [#4](https://github.com/mattstruble/zero-router/pull/4) in [mattstruble/zero-router](https://github.com/mattstruble/zero-router)
4. 🎉 Merged PR [#3](https://github.com/mattstruble/zero-router/pull/3) in [mattstruble/zero-router](https://github.com/mattstruble/zero-router)
5. 💪 Opened PR [#3](https://github.com/mattstruble/zero-router/pull/3) in [mattstruble/zero-router](https://github.com/mattstruble/zero-router)
