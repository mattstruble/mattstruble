...
1. 🎉 Merged PR [#8](https://github.com/mattstruble/zero-router/pull/8) in [mattstruble/zero-router](https://github.com/mattstruble/zero-router)
2. 💪 Opened PR [#7](https://github.com/mattstruble/zero-router/pull/7) in [mattstruble/zero-router](https://github.com/mattstruble/zero-router)
3. 🎉 Merged PR [#6](https://github.com/mattstruble/zero-router/pull/6) in [mattstruble/zero-router](https://github.com/mattstruble/zero-router)
4. 💪 Opened PR [#6](https://github.com/mattstruble/zero-router/pull/6) in [mattstruble/zero-router](https://github.com/mattstruble/zero-router)
5. 🎉 Merged PR [#5](https://github.com/mattstruble/zero-router/pull/5) in [mattstruble/zero-router](https://github.com/mattstruble/zero-router)
