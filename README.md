...
1. 💪 Opened PR [#3](https://github.com/mattstruble/zero-router/pull/3) in [mattstruble/zero-router](https://github.com/mattstruble/zero-router)
2. 🎉 Merged PR [#2](https://github.com/mattstruble/zero-router/pull/2) in [mattstruble/zero-router](https://github.com/mattstruble/zero-router)
3. 💪 Opened PR [#2](https://github.com/mattstruble/zero-router/pull/2) in [mattstruble/zero-router](https://github.com/mattstruble/zero-router)
4. 🎉 Merged PR [#1](https://github.com/mattstruble/zero-router/pull/1) in [mattstruble/zero-router](https://github.com/mattstruble/zero-router)
5. 💪 Opened PR [#1](https://github.com/mattstruble/zero-router/pull/1) in [mattstruble/zero-router](https://github.com/mattstruble/zero-router)
